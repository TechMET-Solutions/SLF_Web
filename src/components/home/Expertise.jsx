...
const Expertise = () => {
    const points = [
        {
            icon: <TrendingDown className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-yellow-500" />,
            title: "Competitive rate of interest",
        },
        {
            icon: <Banknote className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-yellow-500" />,
            title: "No document charges",
        },
        {
            icon: <LockKeyholeOpen className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-yellow-500" />,
            title: "Branches open 7 days of the week",
        },
        {
            icon: <Handshake className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-yellow-500" />,
            title: "Different schemes for customers",
        },
        {
            icon: <TrendingUp className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-yellow-500" />,
            title: "Higher Loan-to-Value ratio",
        },
        {
            icon: <Percent className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-yellow-500" />,
            title: "Instant Gold Valuation",
        },
    ];

    return (
        <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-10 lg:px-16 bg-white font-sans">
            {/* Heading */}
