...
const Footer = () => {
    return (
        <footer className="bg-[#1F2933] text-gray-300 py-12 px-6 md:px-16 font-sans">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div className="space-y-4 flex flex-col items-start justify-center">
                    <div className="flex items-center justify-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-white leading-none">S Lunawat</h1>
                            <p className="text-gray-100 text-sm">Finance</p>
                        </div>
                    </div>
                ...
                {/* Quick Links */}
                <div>
                    <h3 className="text-yellow-500 font-semibold mb-6 text-lg">Quick Links</h3>
                ...
                {/* Resources */}
                <div>
                    <h3 className="text-yellow-500 font-semibold mb-6 text-lg">Resources</h3>
                    <ul className="space-y-4 text-sm">
                        ...
                        <li><a href="#" className="hover:text-white transition">Fare Practice Code</a></li>
                    </ul>
                </div>

                {/* Contact Us */}
                <div>
                    <h3 className="text-yellow-500 font-semibold mb-6 text-lg">Contact Us</h3>
                    <div className="space-y-4 text-sm">
                        ...
                        <div className="flex gap-3">
                            ...
                            <p>
                                ...
                                <span className="ml-12 text-gray-300">9420406622</span>
                            </p>
                        </div>
                        <div className="flex gap-3">
            ...
            {/* Bottom Copyright */}
            <div className="flex items-center justify-between max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-700">
                <p className="text-xs text-gray-500 text-center md:text-left">
                    © 2023 S_Lunawat_Finance_Pvt_Ltd. All Rights Reserved.
                </p>
                <p className="text-xs text-gray-500 text-center md:text-left">
